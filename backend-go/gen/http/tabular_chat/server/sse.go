...
// StreamServerStream implements the tabularchat.StreamServerStream interface
...
// Send Send streams instances of "tabularchat.SSEEvent" to the "stream"
// endpoint SSE connection.
func (s *StreamServerStream) Send(v *tabularchat.SSEEvent) error {
...
// SendWithContext SendWithContext streams instances of "tabularchat.SSEEvent"
// to the "stream" endpoint SSE connection with context.
func (s *StreamServerStream) SendWithContext(ctx context.Context, v *tabularchat.SSEEvent) error {
	s.initHeaders()
	res := v
