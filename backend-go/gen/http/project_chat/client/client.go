...
//
// project_chat client HTTP transport
//
// Command:
...
// Client lists the project_chat service endpoint HTTP clients.
type Client struct {
...
} // NewClient instantiates HTTP clients for all the project_chat service servers.
...
} // Stream returns an endpoint that makes HTTP requests to the project_chat
...
func (c *Client) Stream() loom.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			return nil, loomhttp.ErrRequestError("project_chat", "stream", err)
		}
