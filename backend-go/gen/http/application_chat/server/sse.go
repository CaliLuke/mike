...
// StreamServerStream implements the applicationchat.StreamServerStream
...
// Send Send streams instances of "applicationchat.SSEEvent" to the "stream"
// endpoint SSE connection.
func (s *StreamServerStream) Send(v *applicationchat.SSEEvent) error {
...
// "applicationchat.SSEEvent" to the "stream" endpoint SSE connection with
// context.
func (s *StreamServerStream) SendWithContext(ctx context.Context, v *applicationchat.SSEEvent) error {
	s.initHeaders()
	res := v
