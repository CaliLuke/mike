...
} // Profile returns an endpoint that makes HTTP requests to the user service
// profile server.
func (c *Client) Profile() loom.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			return nil, loomhttp.ErrRequestError("user", "profile", err)
		}
		return decodeResponse(resp)
	}
} // DeleteAccount returns an endpoint that makes HTTP requests to the user
// service delete_account server.
func (c *Client) DeleteAccount() loom.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			return nil, loomhttp.ErrRequestError("user", "delete_account", err)
		}
		return decodeResponse(resp)
	}
}
