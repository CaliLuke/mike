...
// Service is the companies service interface.
type Service interface {
	// List implements list.
	List(context.Context) (res []*Company, err error)
	// Create implements create.
	Create(context.Context, *CreatePayload) (res *Company, err error)
	// Get implements get.
	Get(context.Context, *GetPayload) (res *Company, err error)
	// Update implements update.
	Update(context.Context, *UpdatePayload) (res *Company, err error)
...
// MethodKey key.
var MethodNames = [5]string{"list", "create", "get", "update", "delete"}
...
// Company is the result type of the companies service create method.
type Company struct {
	ID               string  `json:"id"`
...
// CreatePayload is the payload type of the companies service create method.
type CreatePayload struct {
	Name    string  `json:"name"`
	Website *string `json:"website,omitempty"`
}

// DeletePayload is the payload type of the companies service delete method.
type DeletePayload struct {
	CompanyID string `json:"companyId"`
}

// GetPayload is the payload type of the companies service get method.
type GetPayload struct {
	CompanyID string `json:"companyId"`
}

// UpdatePayload is the payload type of the companies service update method.
