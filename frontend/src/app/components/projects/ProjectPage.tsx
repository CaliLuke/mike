...
export function ProjectPage({ projectId }: Props) {
  ...
  useEffect(() => {
    Promise.all([
      ...
      listProjectChats(projectId).catch(() => [] as LukeChat[]),
      ...
      <div ref={actionsRef} className="relative">
        ...
        {actionsOpen && (
          <div className="absolute top-full right-0 z-50 mt-1 w-36 overflow-hidden rounded-lg border border-gray-100 bg-white shadow-lg">
            ...
            {tab === "documents" &&
              selectedDocIds.some((id) => docs.find((d) => d.id === id)?.folder_id != null) && (
                <button
  ...
  return (
    <div className="flex h-full flex-1 flex-col overflow-y-auto bg-white">
      ...
      <div className="flex items-start justify-between px-8 py-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex h-8 w-8 cursor-pointer items-center justify-center text-sm text-gray-500 transition-colors hover:text-gray-900"
                  ...
                  {filteredChats.map((chat) => (
                    <div
                      ...
                      onClick={() => {
                        ...
                        router.push(`/projects/${projectId}/assistant/chat/${chat.id}`);
                      }}
                      className="group flex h-10 cursor-pointer items-center border-b border-gray-50 pr-8 transition-colors hover:bg-gray-50"
                    >
                      <div
      ...
      <PeopleModal
        ...
        breadcrumb={[
          "Projects",
          project ? project.name + (project.cm_number ? ` (${project.cm_number})` : "") : "",
          "People",
        ]}
