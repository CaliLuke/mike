...
import { addDocumentToProject, createProject, uploadProjectDocument } from "@/app/lib/lukeApi";
...
interface Props {
  open: boolean;
  onClose: () => void;
  onCreated: (project: LukeProject) => void;
}
...
export function NewProjectModal({ open, onClose, onCreated }: Props) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setError("");
    try {
      const project = await createProject(name.trim(), cmNumber.trim() || undefined, sharedEmails);
      await Promise.all([
