...
export function EmailPillInput({
  ...
  return (
    <div>
      <div
        className={`flex min-h-[40px] flex-wrap gap-1.5 rounded-lg border bg-gray-50 px-3 py-2 transition-colors ${
          error
      ...
      >
        ...
        <input
          ...
          className="min-w-[160px] flex-1 bg-transparent text-sm text-gray-700 outline-none placeholder:text-gray-400"
          autoFocus={autoFocus}
        />
      </div>
