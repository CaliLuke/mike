...
export const STANDARD_FONT_DATA_URL = "https://unpkg.com/pdfjs-dist@4.10.38/standard_fonts/";
...
export async function highlightQuote(textDivs: HTMLElement[], quote: string): Promise<boolean> {
