...
export function TREditColumnMenu({ column, disabled, onSave, onDelete }: TREditColumnMenuProps) {
  ...
  return (
    <div className="relative shrink-0" onClick={(e) => e.stopPropagation()}>
      ...
      {open && (
        <div
          className="absolute top-full right-0 z-20 mt-1.5 w-72 rounded-xl border border-gray-100 bg-white p-3 shadow-lg"
          onClick={(e) => e.stopPropagation()}
        >
          <div className="mb-3 flex items-center justify-between">
            <p className="text-sm font-medium text-gray-800">Edit Column</p>
            <button
              type="button"
          ...
          <input
            ...
            className="mt-1 w-full rounded-md border border-gray-200 px-2 py-1 text-xs font-normal text-gray-800 focus:border-gray-400 focus:outline-none"
          />

          {/* Format */}
          <div className="mt-3">
            <label className="text-xs font-medium text-gray-800">Format</label>
            <DropdownMenu>
          ...
          {format === "tag" && (
            <div className="mt-2">
              <div className="flex min-h-[28px] flex-wrap gap-1 rounded-md border border-gray-200 px-2 py-1 focus-within:border-gray-400">
                {tags.map((tag, tagIdx) => (
                  <span
                    key={tag}
          ...
          <div className="mt-3">
            <div className="flex items-center justify-between">
              <label className="text-xs font-medium text-gray-800">Prompt</label>
              <button
                type="button"
            ...
            <textarea
              ...
              className="mt-2 w-full resize-none rounded-lg border border-gray-200 bg-white px-3 py-2 text-xs leading-relaxed font-normal text-gray-800 placeholder-gray-300 focus:border-gray-400 focus:outline-none"
            />
          </div>
          ...
          <div className="mt-3 flex items-center justify-between gap-2">
            ...
            <button
              type="button"
              onClick={handleSave}
              disabled={saving || deleting || generating || !name.trim() || !prompt.trim()}
