...
export const PROMPT_PRESETS: ColumnPreset[] = [
  ...
  },
  {
    ...
    format: "company",
    prompt:
      "Identify every company or employer mentioned in this document and the user's relationship to each (employee, founder, contractor, advisor, etc.). For each one, write a bullet in this exact shape:\n" +
      "• <Company name> — <Role> (<Start date> – <End date or 'Present'>)\n" +
      'Use the most specific role title in the document. Use "Mon YYYY" dates (e.g. "Mar 2021"); if a date is missing, write "Unknown". Sort most recent first. One bullet per company-role pair. No other text.',
  },
  {
    name: "Governing Law",
